...
# %%
station_data, station_filename, station_compiled_metadata, (dd, mm, yyyy) = get_renamed_annotated(download_date=(1,10,2023))
...
table_schema = {
    "columns": [
        ...
        {"name": "address_supplement", "data_type": "varchar(300)", "is_nullable": True},        
